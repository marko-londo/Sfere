...
gen_mod_path = r"C:\Users\londo\01\001\Repos\Sfere\Models\GPT2\generator_modelv5"
gen_tok_path = r"C:\Users\londo\01\001\Repos\Sfere\Models\GPT2\gen_tokenizerv5"
pred_mod_path = r"C:\Users\londo\01\001\Repos\Sfere\Models\Keras\is_dying_earth_model.keras"
pred_tok_path = r"C:\Users\londo\01\001\Repos\Sfere\Models\Keras\tokenizer.pkl"
starter_prompts_path = r"C:\Users\londo\01\001\Repos\Sfere\Notebooks\04-Machine-Learning\prompt_starters_list.pickle"
non_dying_earth_text_path = r"C:\Users\londo\01\001\Repos\Sfere\Notebooks\04-Machine-Learning\book_dictionary.pkl"
...
def sentence_plot(generated_text_cleaned):
    ...
    dying_earth_score = [predict_dying_earth(sentence) for sentence in sentences]
    df = pd.DataFrame({
        'Sequence': range(1, len(dying_earth_score) + 1),
        "Probability": dying_earth_score,
        'Sentence': sentences
    })
    
    fig = px.line(df, x='Sequence', y='Probability',
                title='Probability of Each Sentence Being from a Dying Earth Novel (Stop Words Removed)',
                hover_data=['Sentence'], width=1000, height=600)
...
def show():
    ...
    def show_tab1(tab):
        with tab: 
            ...
            st.write('Click the "Cosmic Reset" button to start over.')
            st.divider()
